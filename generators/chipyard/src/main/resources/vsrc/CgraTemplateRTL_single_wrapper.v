...
module CgraTemplateRTL_single_wrapper (
  ...
  input  logic [224:0] recv_from_cpu_pkt_msg,
  output logic        recv_from_cpu_pkt_rdy,
  output logic        send_to_cpu_pkt_val,
  output logic [224:0] send_to_cpu_pkt_msg,
  input  logic        send_to_cpu_pkt_rdy,
  input  logic        recv_from_inter_cgra_noc_val,
  input  logic [228:0] recv_from_inter_cgra_noc_msg,
  output logic        recv_from_inter_cgra_noc_rdy,
  output logic        send_to_inter_cgra_noc_val,
  output logic [228:0] send_to_inter_cgra_noc_msg,
  input  logic        send_to_inter_cgra_noc_rdy,
  input  logic cgra_id,
  input  logic [7:0] address_lower,
  input  logic [7:0] address_upper
);

  IntraCgraPacket_1_1x1_16_8_2_CgraPayload__51c91a3288e79e56 w_recv_from_cpu_pkt_msg;
  IntraCgraPacket_1_1x1_16_8_2_CgraPayload__51c91a3288e79e56 w_send_to_cpu_pkt_msg;
  InterCgraPacket_1_1x1_16_8_4_CgraPayload__929827fdd654d2fa w_recv_from_inter_cgra_noc_msg;
  InterCgraPacket_1_1x1_16_8_4_CgraPayload__929827fdd654d2fa w_send_to_inter_cgra_noc_msg;
